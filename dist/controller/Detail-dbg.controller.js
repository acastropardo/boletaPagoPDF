...
sap.ui.define([
	...
	return BaseController.extend("pdf.ZHR_TEST_BOLETA_PAGO.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("periodosCollection", {
					Seqnr: sObjectId
				});
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getPath(),
				...
				sObjectId = oObject.Seqnr,
				sObjectName = oObject.Seqnr,
				oViewModel = this.getModel("detailView");
