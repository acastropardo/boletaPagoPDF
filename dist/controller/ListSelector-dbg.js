sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("pdf.ZHR_TEST_BOLETA_PAGO.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias pdf.ZHR_TEST_BOLETA_PAGO.controller.ListSelector
			 */
			 ...
			 * @return {pdf.ZHR_TEST_BOLETA_PAGO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
