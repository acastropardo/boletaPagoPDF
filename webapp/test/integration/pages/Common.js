sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("pdf/ZHR_TEST_BOLETA_PAGO/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("pdf.ZHR_TEST_BOLETA_PAGO.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["pdf/ZHR_TEST_BOLETA_PAGO/localService/mockserver"], function (mockserver) {
